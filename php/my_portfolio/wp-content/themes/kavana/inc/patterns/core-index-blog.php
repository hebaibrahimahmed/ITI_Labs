<?php
/**
 * Core Index Blog content.
 */
return array(
	'title'      => __( 'Core Index Blog', 'kavana' ),
	'categories' => array( 'kavana-basic' ),
	'content'    => '<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"80px","bottom":"80px","right":"20px","left":"20px"}}},"textColor":"third","layout":{"inherit":true,"type":"constrained"}} -->
...
<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"500","lineHeight":"1.5"},"spacing":{"margin":{"right":"0px","bottom":"0px"}},"color":{"text":"#1d1b15"}},"fontSize":"large"} /-->
...
<!-- wp:query-pagination {"paginationArrow":"arrow","style":{"color":{"text":"#1d1b15"},"elements":{"link":{"color":{"text":"#ad7531"}}},"typography":{"fontSize":"14px","fontStyle":"normal","fontWeight":"400","lineHeight":"1.5"}},"className":"kavana-animate kavana-move-up kavana-delay-2","layout":{"type":"flex","justifyContent":"center"},"fontFamily":"secondary"} -->
